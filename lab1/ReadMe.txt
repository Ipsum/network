---- ReadMe.txt for UDP server and client ---
 ...
 Client.py is the module run as the UDP client process.
    ...
    - To send a file to the server:
        ...
        2. Navigate to the directory containing the file and Client.py
        3. Run the script in the following manner - "python Client.py send [filename]"
            - Alternatively, 's' can be used instead of 'send'
    - To get a file from the server:
        1. Navigate to the directory containing Client.py 
        2. Run the script in the following manner - "python Client.py get [filename]"
            - Alternatively, 'g' can be used instead of 'g'
        3. The file should then be available in the directory
